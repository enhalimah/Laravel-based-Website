...
<link rel="stylesheet" href="/css/style.css">
    ...
    <script>
        alert("Hai, <?php echo e(session('username')); ?>! Enjoy your shopping!");
        <?php echo Session::forget('username'); ?>

    </script>
    <?php endif; ?>

    <?php if(session('successpayment')): ?>
    <script>
        alert("<?php echo e(session('successpayment')); ?>");
    </script>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\College\Semester 4\xamppp\htdocs\WebFramework\resources\views/pages/homepage.blade.php ENDPATH**/ ?>